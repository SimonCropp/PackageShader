...
public static class ClassWithStaticFields
{
    ...
    public static ReadOnlySpan<byte> ByteData => new byte[] { 1, 2, 3, 4, 5, 6, 7, 8 };

    public static ReadOnlySpan<int> IntData => new int[] { 100, 200, 300, 400, 500 };

    // Prime numbers similar to what FrozenSet uses
    public static ReadOnlySpan<int> Primes => new int[]
    {
